        ...
        <div class="row row justify-content-center align-items-center">
            <div class="col-10 text-center">
                <div class="card">
                    ...
                    <form class="was-validated" method="POST" action="../controller/inserirReacao.php">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="motivo" id="validationTextarea" placeholder="Motivo do reconhecimento" required></textarea>
                        ...
                        <div class="butns">
                            ...
                            <center><button type="submit" class="btn">Reconhecer</button></center>
                        </div>
                    </form>
                </div>
            </div>
