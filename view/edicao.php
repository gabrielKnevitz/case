...
$consulta= "SELECT * FROM tb_reacoes where id_reacao= '{$id_reacao}'";
$resultado= $conexao->query($consulta);

while($dado = $resultado->fetch_assoc()){
    $elogiado = $dado['elogiado'];
    $elogiador = $dado['elogiador'];
    $motivo = $dado['motivo'];
    $elogio = $dado['elogio'];
}
?>
...
<head>
    ...
    <link rel="stylesheet" href="../public/css/customizacaoReagir.css">
        ...
        <div class="row row justify-content-center align-items-center">
            <div class="col-10 text-center">
                <div class="card">
                    ...
                    <form class="was-validated" method="POST" action="../controller/atualizar.php">
                        <input name="id" type="hidden" value=<?php echo $id_reacao;?>>
                        <input name="elogiado" type="hidden" value=<?php echo $elogiado;?>>
                        <input name="elogiador" type="hidden" value=<?php echo $elogiador;?>>
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    <label for="validationTextarea" class="form-label"></label>
                                    <textarea class="form-control" name="motivo" id="validationTextarea" placeholder="Motivo do reconhecimento" required><?php echo $motivo;?></textarea>
                                    <div class="invalid-feedback"></div>
                                </div>
                            </div>
                        </div>
                        <div class="butns">
                            <input type="radio" name="botao" value="Like"> 
                            ...
                            <input type="radio" name="botao" value="Orgulho">            
                            ...
                            <input type="radio" name="botao" value="Excelente trabalho"> 
                                <button type="button" class="efeito botao Excelente">
                                    <img src="../images/palmas.png">
                                </button>
                            <input type="radio" name="botao" value="Colaboração"> 
                            ...
                            <center><button type="submit" class="btn">Atualizar</button></center>
                        </div>
                    </form>
                </div>
            </div>
